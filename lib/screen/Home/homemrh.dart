...
class HomeMRH extends StatefulWidget {
  ...
  HomeMRH({this.actualuser});

  @override
  _HomeMRHState createState() => _HomeMRHState(actualuser: actualuser);
}

class _HomeMRHState extends State<HomeMRH> {
